  ...
  return (
    <>
      <div class="container Align">
        ...
        <h1>Registration( NID )</h1>
        <h5>Complete your registration using NID card number</h5>
      </div>
          ...
          <div className="mt-3 mb-3">
            ...
            <Row>
              <Col md={5}>
                ...
                <Form.Control
                  type="text"
                  placeholder="Example - 691 017 7689"
                  name="uniqueId"
                  value={user.uniqueId}
              ...
              <Col md={5}>
                <Form.Label>Date of birth ( According to NID )</Form.Label>
                <Row>
                  <Col md={4}>
                    <Form.Select
