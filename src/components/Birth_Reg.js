  ...
  return (
    <>
      <div class="container Align">
        ...
        <h1>Registration( Birth Registration Card )</h1>
        <h5>Complete your registration using Birth Registration Card number</h5>
      </div>
      ...
      <Container>
        <Form>
          ...
          <div className="mt-3 mb-3">
            ...
            <Row>
              <Col md={5}>
                <Form.Label>Birth Registration Card Number</Form.Label>
                <Form.Control
                  type="text"
                  placeholder="Example - 20002721201000156"
                  name="uniqueId"
                  value={user.uniqueId}
              ...
              <Col md={5}>
                <Form.Label>Date of birth ( According to Birth Registration Certificate )</Form.Label>
                <Row>
                  <Col md={4}>
                    <Form.Select
            ...
            <Row>
              ...
              <Col md={5}>
                ...
                <Form.Select
                  ...
                  onChange={handleChange}
                >
                  <option selected>Choose your center</option>
